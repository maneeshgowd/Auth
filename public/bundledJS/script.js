...
var loginIcon = document.getElementById("login-pass-icon");
var forgetPassIcon = document.querySelectorAll("#forget-pass-icon");
var loginEmail = document.getElementById("email");
var loginIn = document.getElementById("form--login");
var createPassword = document.getElementById("new-password");
var createRepeatPassword = document.getElementById("repeat-password");
var createName = document.getElementById("name");
var createEmail = document.getElementById("create-email");
var createIcon = document.querySelectorAll("#create-pass-icon");
var signUp = document.getElementById("form--create");
var validateOtp = document.getElementById("form--otp");
var gender = document.getElementById("gender");
var dob = document.getElementById("dob"); /////

var logoutuser = document.querySelector("#logout-user");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            return _context.abrupt("return", errorDisplay("".concat(response.message), "error"));

          case 9:
            errorDisplay("".concat(response.message), "success");
          ...
          case 13:
            ...
            errorDisplay("".concat(_context.t0.message), "error");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            ...
            errorDisplay("".concat(_context2.t0.message), "error");
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return fetch("http://127.0.0.1:3000/api/v1/users/".concat(endPoint), {
              method: "POST",
              headers: {
                "Content-Type": "application/json"
              },
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return fetch("http://127.0.0.1:3000/api/v1/users/forgotPassword", {
              method: "POST",
              headers: {
                "Content-Type": "application/json"
              },
          ...
          case 13:
            ...
            errorDisplay("".concat(_context4.t0.message), "error");
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee5(data, token) {
    var request, response;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return fetch("http://127.0.0.1:3000/api/v1/users/resetPassword/".concat(token), {
              method: "PATCH",
              headers: {
                "Content-Type": "application/json"
              },
          ...
          case 13:
            ...
            errorDisplay("".concat(_context5.t0.message), "error");
  ...
  return function resetForgetPassword(_x5, _x6) {
...
function validateOTP(e) {
  ...
  errorDisplay("Successfully signed.", "success"); // send data to backend
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee6(token, e) {
    var email, response;
  ...
  return function viewSendForgetEmail(_x7, _x8) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee7(inputArr) {
    var _inputArr, name, email, password, repeatPassword, gender, dob, validatedData, userData, otp;

    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _inputArr = _slicedToArray(inputArr, 6), name = _inputArr[0], email = _inputArr[1], password = _inputArr[2], repeatPassword = _inputArr[3], gender = _inputArr[4], dob = _inputArr[5];
            validatedData = userAuthenticator(email.value.trim(), password.value.trim(), repeatPassword.value.trim(), name.value.trim(), gender.value, dob.value.trim());
            ...
            return _context7.abrupt("return", errorDisplay("Passwords dosen't match"));
          ...
          case 4:
            ...
            _context7.next = 8;
            return userSignup(userData, "validate");
          ...
          case 8:
            ...
            return _context7.abrupt("return", errorDisplay(otp.message, "error"));
  ...
  return function viewAuthCreate(_x9) {
    return _ref7.apply(this, arguments);
  };
}();

var viewAuthLogin = function viewAuthLogin(inputArr) {
  var _inputArr2 = _slicedToArray(inputArr, 2),
      email = _inputArr2[0],
      password = _inputArr2[1];
...
signUp?.addEventListener("submit", function (e) {
  e.preventDefault();
  var data = [createName, createEmail, createPassword, createRepeatPassword, gender, dob];
  viewAuthCreate.call(signUp, data);
});
loginIn?.addEventListener("submit", function (e) {
  e.preventDefault();
...
createIcon[0]?.addEventListener("click", viewPasswordVisibleHandler.bind(createIcon[0], createPassword));
createIcon[1]?.addEventListener("click", viewPasswordVisibleHandler.bind(createIcon[1], createRepeatPassword));
forgetPassIcon[0]?.addEventListener("click", viewPasswordVisibleHandler.bind(forgetPassIcon[0], createRepeatPassword));
forgetPassIcon[1]?.addEventListener("click", viewPasswordVisibleHandler.bind(forgetPassIcon[1], createRepeatPassword));
},{"core-js/stable":"../../node_modules/core-js/stable/index.js","regenerator-runtime":"../../node_modules/regenerator-runtime/runtime.js"}],"../../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
